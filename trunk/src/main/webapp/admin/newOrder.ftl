...
<head>
    <title>NewOrder Management</title>
		...
		<tr>
			<td width="10%" class="menuTd">
				...
				<table width="100%" align="top">
					...
					<tr class="menuItem">
						<td>
							<a href="${rc.getContextPath()}/admin/order.html" title="OldOrder Mananger"><span>Old Order</span></a>
						</td>
					</tr>
				</table>
				</div>
			...
			<td width="89%" class="dataTable">
				<div class="dataTableTitle">
					<span>New Order Page</span><br/>
				
				</div>
				<div class="dataTableToolbar">
					<span>New Order List Table</span>
					
				</div>
				<!--<p>Messages:</p>-->
				<div id="showArea"></div>
				
				<div id="newOrderTable"></div>
			</td>
